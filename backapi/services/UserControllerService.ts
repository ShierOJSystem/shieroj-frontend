...
import type { BaseResponse_UserCodeVO_ } from '../models/BaseResponse_UserCodeVO_';
...
id?: number,
     ...
     * 获取包装类用户
     * @param id id
     * @returns BaseResponse_UserCodeVO_ OK
     * @throws ApiError
     */
    public static getUserVoByIdUsingGet(
id?: number,
): CancelablePromise<BaseResponse_UserCodeVO_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/get/vo',
            query: {
